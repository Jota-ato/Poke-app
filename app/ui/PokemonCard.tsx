...
export default function PokemonCard({ pokemon }: PokemonCardProps) {
    return (
        <article className="p-4 sm:p-6 bg-green-400 rounded-xl sm:rounded-2xl shadow-xl flex flex-col md:flex-row items-center justify-between h-80">
            <div className="w-full md:w-auto md:flex-1 text-center md:text-left mb-4 md:mb-0">
                ...
                {/* Tipos */}
                <div className="flex flex-row md:flex-col gap-2 sm:gap-3 justify-center md:justify-start flex-wrap">
            ...
            <div className="relative w-full md:w-auto md:shrink-0">
                <Image
                    ...
                    className="w-full h-auto md:-mb-6 md:-mr-6"
                    height={500}
                    width={500}
                    priority
